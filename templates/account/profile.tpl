					...
					<div>
						<div class="text-center">
							<span>
								...
								<span class="account-username" <!-- IF groups.length --> <!-- BEGIN groups --> style="color: {groups.labelColor};text-shadow:0 0 0.7em {groups.labelColor};" <!-- END groups --> <!-- ENDIF groups.length --> > {username}</span>
							</span>
